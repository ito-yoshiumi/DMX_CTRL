...
### ループ2（来客後：5分体験）
1. **Phase 1: チューニング（チュートリアル）**
   - 「わー」と言ってみて → 声量/音程で全ライトが高さ/色変化
   - **音程アシスト機能**: 目標の高さ（音程）に合うまで「もう少し高く」「低いよ」などと音声で誘導
   - 自分の声が光になる感覚を掴む
2. **Phase 2: あいさつ合唱**
   - 1音につき1つのライトが対応して動く
   - 「ドレミファソ」などの5音でシステムと挨拶を交わす
3. **Phase 3: AI輪唱とリアクション**
   - ユーザーの歌い方に合わせてシステムが輪唱（追いかける/ハモる）
   - ズレや調和具合をAIが判定し、「綺麗なハモリだね」「面白いリズムだね」等と感想が変化
   - 毎回異なる音階や反応で飽きさせない
...
### P2（ゲームフロー再構築：5分体験）
- [ ] **Phase 1: チューニング**（全ライト制御＋音程誘導アシスト）
- [ ] **Phase 2: あいさつ合唱**（1音1ライト個別制御）
- [ ] **Phase 3: AI輪唱とリアクション**（ズレ/調和判定、感想分岐、生成AI）
